...
// 
namespace DownloadFileInChunk.DownloadFile {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DownloadFile.IDownloadFile")]
    public interface IDownloadFile {
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IDownloadFile/DownloadChunk", ReplyAction="http://tempuri.org/IDownloadFile/DownloadChunkResponse")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDownloadFileChannel : DownloadFileInChunk.DownloadFile.IDownloadFile, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DownloadFileClient : System.ServiceModel.ClientBase<DownloadFileInChunk.DownloadFile.IDownloadFile>, DownloadFileInChunk.DownloadFile.IDownloadFile {
        ...
        public DownloadFileClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public DownloadFileClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public DownloadFileClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public DownloadFileClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
        ...
        System.IAsyncResult DownloadFileInChunk.DownloadFile.IDownloadFile.BeginDownloadChunk(string Docurl, long Offset, int BufferSize, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginDownloadChunk(Docurl, Offset, BufferSize, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        byte[] DownloadFileInChunk.DownloadFile.IDownloadFile.EndDownloadChunk(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginDownloadChunk(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((DownloadFileInChunk.DownloadFile.IDownloadFile)(this)).BeginDownloadChunk(Docurl, Offset, BufferSize, callback, asyncState);
        }
        
        private object[] OnEndDownloadChunk(System.IAsyncResult result) {
            byte[] retVal = ((DownloadFileInChunk.DownloadFile.IDownloadFile)(this)).EndDownloadChunk(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override DownloadFileInChunk.DownloadFile.IDownloadFile CreateChannel() {
            return new DownloadFileClientChannel(this);
        }
        
        private class DownloadFileClientChannel : ChannelBase<DownloadFileInChunk.DownloadFile.IDownloadFile>, DownloadFileInChunk.DownloadFile.IDownloadFile {
            
            public DownloadFileClientChannel(System.ServiceModel.ClientBase<DownloadFileInChunk.DownloadFile.IDownloadFile> client) : 
                    base(client) {
            }
